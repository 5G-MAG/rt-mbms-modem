...
/* Map ASN.1 mch_sched_period_r9 integer value to our extended enum.
 * ASN.1 R9 order: rf8=0, rf16=1, rf32=2, rf64=3, rf128=4, rf256=5, rf512=6, rf1024=7.
 * Rel-19 new values (rf7,rf14,rf28,rf53,rf56,rf108,rf112,rf212,rf424) arrive via ext IEs. */
static pmch_info_t::mch_sched_period_t asn1_mch_period_r9(uint8_t v)
{
...
pmch_info_t make_pmch_info(const asn1::rrc::pmch_info_r9_s& asn1_type)
{
  ...
  ret.mch_sched_period = asn1_mch_period_r9(asn1_type.pmch_cfg_r9.mch_sched_period_r9.value);
...
/* Map ASN.1 common_sf_alloc_period_r9 to our extended enum.
 * ASN.1 R9 order: rf4=0, rf8=1, rf16=2, rf32=3, rf64=4, rf128=5, rf256=6. */
static mcch_msg_t::common_sf_alloc_period_t asn1_common_alloc_period_r9(uint8_t v)
{
  using P = mcch_msg_t::common_sf_alloc_period_t;
  switch (v) {
    case 0: return P::rf4;
    case 1: return P::rf8;
...
static pmch_info_t::mch_sched_period_t asn1_mch_period_r12(uint8_t v)
{
  using P = pmch_info_t::mch_sched_period_t;
  switch (v) {
    case 0: return P::rf4;
...
/* PMCH-SoftBufferSizeParameters-r19 scalingFactorBeta <-> num/den. Only the
 * decode direction is needed on this receive-only repo (see make_pmch_info_ext_r19
 * below); kept as a small lookup table rather than arithmetic on the enum's
 * ordinal so it stays correct if the enum's declaration order ever changes. */
namespace {
...
const beta_frac_entry_t beta_frac_table[] = {
    {beta_e_::one32nd, 1, 32},
    {beta_e_::one5th, 1, 5},
    {beta_e_::one3rd, 1, 3},
    {beta_e_::three8th, 3, 8},
    {beta_e_::five12th, 5, 12},
    {beta_e_::onehalf, 1, 2},
    {beta_e_::five8th, 5, 8},
    {beta_e_::two3rd, 2, 3},
    {beta_e_::five6th, 5, 6},
...
static pmch_info_t make_pmch_info_ext_r19(const asn1::rrc::pmch_info_ext_r19_s& asn1_type)
{
  pmch_info_t ret{};
  ...
  if (asn1_type.pmch_tfi_cfg_r19_present) {
    ...
    if (tfi.mch_sched_period_v1900_present) {
      ret.mch_sched_period = asn1_mch_period_v1900(tfi.mch_sched_period_v1900.value);
    }
    if (tfi.time_interleav_cfg_r19_present) {
       ...
       * presence bits, mirrors the TX repo's encode side (rrc.cc pack_mcch()) --
       * 0 in the internal struct means "absent/inherit main". */
...
mcch_msg_t make_mcch_msg(const asn1::rrc::mcch_msg_s& asn1_type)
{
  ...
  msg.common_sf_alloc_period = asn1_common_alloc_period_r9(r9.common_sf_alloc_period_r9.value);
