...
/* TS 36.211 §6.10.2.1.3-4: 2.5 kHz and 0.37 kHz RS sequences have a 40 ms period.
 * Allocate the pilot table for the full 40 ms period (40 entries). */
...
typedef struct SRSRAN_API {
  srsran_cell_t cell;
  cf_t*         pilots[2][SRSRAN_MBSFN_NOF_SF_40MS]; // Saves the reference signal per subframe for ports 0,1 and ports 2,3; sized for the 40 ms RS period
  srsran_sf_t   type;
